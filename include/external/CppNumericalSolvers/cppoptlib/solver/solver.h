...
namespace cppoptlib::solver {
    ...
    public:
        explicit Solver(const State<scalar_t> &stopping_state = DefaultStoppingSolverState<scalar_t>()) : stopping_state_(stopping_state),
            step_callback_( GetDefaultStepCallback<scalar_t, vector_t, hessian_t>()) {}
        ...
        virtual std::tuple<function_state_t, state_t> Minimize(const function_t &function, const vector_t &x0) 
        {
