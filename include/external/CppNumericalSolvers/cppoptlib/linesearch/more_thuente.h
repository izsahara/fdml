...
namespace cppoptlib {
  namespace solver {
    namespace linesearch {
      ...
      static scalar_t Search(const vector_t &x, const vector_t &search_direction, const Function &function, const scalar_t alpha_init = 1.0) 
      {
      ...
      static int cvsrch(const Function &function, vector_t *x, scalar_t f, vector_t *g, scalar_t *stp, const vector_t &s) 
      {
      ...
      // would be helpful.
      static int cstep(scalar_t &stx, scalar_t &fx, scalar_t &dx, scalar_t &sty, scalar_t &fy, scalar_t &dy, scalar_t &stp, scalar_t &fp, scalar_t &dp, bool &brackt, scalar_t &stpmin,  scalar_t &stpmax, int &info) 
      {            
          info = 0;
          bool bound = false;
